...
const { DISCORD_TOKEN, CHANNEL_ID, OPENSEA_KEY, COLLECTION_SLUG, ENS_PROVIDER_URL } = process.env;
...
const buildMessage = async (sale) => (
  new MessageEmbed()
    ...
    .setAuthor('VizzieBot', 'https://lh3.googleusercontent.com/tXvyzJcs8BpoaxT8b8UkHhls5hebzHDy6zsm-WcDt4AIQ1PpYzT59prf8RRdnL52caWQsHZHi-KHp10IXpmpp04br7sh_xtTQZe7lfY=s130', 'https://opensea.io/collection/thevisitors')
